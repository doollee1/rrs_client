			...
			$.ajax({
				...
				success : function(data) {
					if(data.result == "SUCCESS") {
						isCal = true;
						$("#calAmt").val(numberComma(data.totalAmt));
		...
		<div class="tab-content panel rounded-0 p-3 m-0">
			...
			<div class="tab-pane fade active show" id="default-tab-1">
				...
				<div class="row mb-2">
					...
					<div class="col-sm-9">
						<input id="fligthImage" name="fligthImage" type="file" class="form-control" />
					</div>
				</div>
				<div class="row mb-2">
			...
			<div class="tab-pane fade" id="default-tab-2">
				...
				<div class="mb-2">
					<div class="inline-flex calc">
						...
						<input id="calAmt" name="calAmt" type="text" class="form-control text-end" value="0" readonly>원
					</div>
