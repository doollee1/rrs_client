...
<div class="register register-with-news-feed set">
		...
		<div class="register-content">
			<form action="index.html" method="GET" class="fs-13px">
				<div class="mb-3">
					...
					<input type="text" class="form-control fs-13px" placeholder="이름" readonly id="han_name">
				</div>
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<input type="password" class="form-control fs-13px" placeholder="기존 비밀번호" id="passwd_Ori"/>
				</div>
				<div class="mb-3">
	...
	<div id="footer" class="app-footer m-0">
		<a href="#" class="btn btn-success btn-lg">변  경</a>
	</div>
	<!-- END #footer -->
</div>
<!-- END #register -->